                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td>
  <form method="get" id="payBillForm<?php echo $row['ID']; ?>" onsubmit="return handlePayBill(event, '<?php echo $row['ID']; ?>')">
    <input type="hidden" name="ID" value="<?php echo $row['ID']?>"/>
    <input type="submit" name="generate_bill" class="btn btn-success" value="Pay Bill" id="payBillButton<?php echo $row['ID']; ?>"/>
  </form>
</td>
      ...
      <script>
  function handlePayBill(event, id) {
    event.preventDefault(); // Prevent the default form submission

    // Change the button text to "Bill Paid"
    document.getElementById('payBillButton' + id).value = 'Bill Paid';
    document.getElementById('payBillButton' + id).disabled = true; // Disable the button

    // Submit the form
    document.getElementById('payBillForm' + id).submit();
  }
</script>
